...
static u32 hclks_msdc30[] = { 26000000, 26000000, 48000000, 933330000,
	                10000000, 160000000, 186667000, 200000000};
...
void msdc_set_smt(struct mmc_host *host, int smt)
{
	switch(host->id){
		case 0:
			if(smt)
				MSDC_SET_FIELD(MSDC0_GPIO_SMT_G2_ADDR,MSDC0_SMT_ALL_MASK,0x7BF);
			else
				MSDC_SET_FIELD(MSDC0_GPIO_SMT_G2_ADDR,MSDC0_SMT_ALL_MASK,0x0);
			break;
		case 1:
			if(smt)
				MSDC_SET_FIELD(MSDC1_GPIO_SMT_G1_ADDR,MSDC1_SMT_ALL_MASK,0x3F);
			else
				MSDC_SET_FIELD(MSDC1_GPIO_SMT_G1_ADDR,MSDC1_SMT_ALL_MASK,0x0);
			break;
		default:
...
void msdc_set_sr(struct mmc_host *host, int clk, int cmd, int dat, int rst, int ds)
{
	switch(host->id){
		case 0:
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_CMD_MASK,(cmd != 0));
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_CLK_MASK,(clk != 0));
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_DAT0_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_DAT1_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_DAT2_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_DAT3_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_DAT4_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_DAT5_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_DAT6_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC0_GPIO_SR_G2_ADDR,MSDC0_SR_DAT7_MASK,(dat != 0));
			break;
		case 1:
			MSDC_SET_FIELD(MSDC1_GPIO_SR_G1_ADDR,MSDC1_SR_CMD_MASK,(cmd != 0));
			MSDC_SET_FIELD(MSDC1_GPIO_SR_G1_ADDR,MSDC1_SR_CLK_MASK,(clk != 0));
			MSDC_SET_FIELD(MSDC1_GPIO_SR_G1_ADDR,MSDC1_SR_DAT0_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC1_GPIO_SR_G1_ADDR,MSDC1_SR_DAT1_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC1_GPIO_SR_G1_ADDR,MSDC1_SR_DAT2_MASK,(dat != 0));
			MSDC_SET_FIELD(MSDC1_GPIO_SR_G1_ADDR,MSDC1_SR_DAT3_MASK,(dat != 0));
			break;
		default:
			printf("error...[%s] host->id out of range!!!\n",__func__);
			break;
...
static void msdc_pin_set(struct mmc_host *host, int mode)
{
    switch(host->id){
	case 0:
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_DAT0_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_DAT0_MASK, 0);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_DAT1_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_DAT1_MASK, 0);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_DAT2_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_DAT2_MASK, 0);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_DAT3_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_DAT3_MASK, 0);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_DAT4_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_DAT4_MASK, 0);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_DAT5_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_DAT5_MASK, 0);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_DAT6_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_DAT6_MASK, 0);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_DAT7_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_DAT7_MASK, 0);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_CMD_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_CMD_MASK, 0);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLDN_G2_ADDR, MSDC0_PULLDN_CLK_MASK, 1);
		MSDC_SET_FIELD(MSDC0_GPIO_PULLUP_G2_ADDR, MSDC0_PULLUP_CLK_MASK, 0);
		break;
	case 1:
		MSDC_SET_FIELD(MSDC1_GPIO_PULLUP_G1_ADDR, MSDC1_PULLUP_DAT0_MASK, 1);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLDN_G1_ADDR, MSDC1_PULLDN_DAT0_MASK, 0);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLUP_G1_ADDR, MSDC1_PULLUP_DAT1_MASK, 1);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLDN_G1_ADDR, MSDC1_PULLDN_DAT1_MASK, 0);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLUP_G1_ADDR, MSDC1_PULLUP_DAT2_MASK, 1);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLDN_G1_ADDR, MSDC1_PULLDN_DAT2_MASK, 0);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLUP_G1_ADDR, MSDC1_PULLUP_DAT3_MASK, 1);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLDN_G1_ADDR, MSDC1_PULLDN_DAT3_MASK, 0);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLUP_G1_ADDR, MSDC1_PULLUP_CMD_MASK, 1);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLDN_G1_ADDR, MSDC1_PULLDN_CMD_MASK, 0);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLDN_G1_ADDR, MSDC1_PULLDN_CLK_MASK, 1);
		MSDC_SET_FIELD(MSDC1_GPIO_PULLUP_G1_ADDR, MSDC1_PULLUP_CLK_MASK, 0);	
		break;
	default:
		printf("error...[%s] host->id out of range!!!\n",__func__);
		break;
...
void msdc_set_driving(struct mmc_host *host, struct msdc_cust *msdc_cap, bool sd_18)
{
	switch(host->id){
		case 0:
			/*emmc gpio driving is 8mA default*/
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_CMD_MASK, (msdc_cap->cmd_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_CMD_MASK, (msdc_cap->cmd_drv / 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_CLK_MASK, (msdc_cap->clk_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_CLK_MASK, (msdc_cap->clk_drv / 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_DAT0_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_DAT0_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_DAT1_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_DAT1_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_DAT2_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_DAT2_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_DAT3_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_DAT3_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_DAT4_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_DAT4_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_DAT5_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_DAT5_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_DAT6_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_DAT6_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E4_G2_ADDR, MSDC0_DRV_DAT7_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
			MSDC_SET_FIELD(MSDC0_GPIO_DRV_E8_G2_ADDR, MSDC0_DRV_DAT7_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
			break;
		case 1:
			/*sdcard gpio driving is 8mA deafault*/
			if (sd_18) {
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_CMD_MASK, (msdc_cap->cmd_18v_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_CMD_MASK, (msdc_cap->cmd_18v_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_CLK_MASK, (msdc_cap->clk_18v_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_CLK_MASK, (msdc_cap->clk_18v_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_DAT0_MASK, (msdc_cap->dat_18v_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_DAT0_MASK, (msdc_cap->dat_18v_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_DAT1_MASK, (msdc_cap->dat_18v_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_DAT1_MASK, (msdc_cap->dat_18v_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_DAT2_MASK, (msdc_cap->dat_18v_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_DAT2_MASK, (msdc_cap->dat_18v_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_DAT3_MASK, (msdc_cap->dat_18v_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_DAT3_MASK, (msdc_cap->dat_18v_drv / 2) ? 1 : 0);
			} else {
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_CMD_MASK, (msdc_cap->cmd_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_CMD_MASK, (msdc_cap->cmd_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_CLK_MASK, (msdc_cap->clk_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_CLK_MASK, (msdc_cap->clk_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_DAT0_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_DAT0_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_DAT1_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_DAT1_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_DAT2_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_DAT2_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E4_G1_ADDR, MSDC1_DRV_DAT3_MASK, (msdc_cap->dat_drv % 2) ? 1 : 0);
				MSDC_SET_FIELD(MSDC1_GPIO_DRV_E8_G1_ADDR, MSDC1_DRV_DAT3_MASK, (msdc_cap->dat_drv / 2) ? 1 : 0);
			}
			break;
		default:
			printf("error...[%s] host->id out of range!!!\n",__func__);
...
int msdc_dma_transfer(struct mmc_host *host, struct mmc_command *cmd, struct mmc_data *data)
{
...
#endif
	{
		...
		while (left_sz) {
			...
			if (left_sz) {
				/*standard capacity sdcard uses the memory address in byte address format */
				if (mmc_card_sd(host->card) && (!mmc_card_highcaps(host->card)))
					cmd->arg += (nblks * blksz);
				else
...
#ifndef FPGA_PLATFORM
	if ( host->id == 1) {
		MSDC_SET_FIELD(MSDC_CLK_CFG_3_REG, MSDC_CLK_CFG_3_MSDC31_MASK, clksrc);	  
	} else {
		MSDC_SET_FIELD(MSDC_CLK_CFG_3_REG, MSDC_CLK_CFG_3_MSDC31_MASK, clksrc);	  
	}
#endif		
...
void msdc_clock(struct mmc_host *host, int on)
{
	...
	switch ( host->id){
	case 0 :
		/*emmc clock is keep on*/
		break;
	case 1 :
		/*sdcard clock is keep on */
		break;
	default:
		break;
	}
...
int msdc_init(struct mmc_host *host, int id)
{
...
#ifdef FEATURE_MMC_DATA_TUNING
	MSDC_SET_FIELD(MSDC_PAD_TUNE, MSDC_PAD_TUNE_RXDLYSEL, 0);
	MSDC_SET_FIELD(MSDC_PAD_TUNE, MSDC_PAD_TUNE_DATRRDLYSEL, 1);
	MSDC_SET_FIELD(MSDC_PAD_TUNE, MSDC_PAD_TUNE_CMDRDLYSEL, 1);
#else
	MSDC_SET_FIELD(MSDC_PAD_TUNE, MSDC_PAD_TUNE_RXDLYSEL, 1);
#endif
    ...
    /*don't check data0 status gen cmdrdy interrupt when send R1b cmd
     and don't check write program timeout*/
    MSDC_SET_FIELD(MSDC_PATCH_BIT1, MSDC_PB1_BUSY_CHECK_SEL, 0);

    /*configuration read data clock at block gap*/
